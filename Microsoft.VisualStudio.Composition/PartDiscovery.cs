namespace Microsoft.VisualStudio.Composition
{
    ...
    public abstract class PartDiscovery
    {
        ...
        /// <returns>The metadata view, <see cref="IDictionary{TKey,TValue}"/> where <c>TKey</c> is <see cref="string"/> and <c>TValue</c> is <see cref="object"/>, or <c>null</c> if there is none.</returns>
