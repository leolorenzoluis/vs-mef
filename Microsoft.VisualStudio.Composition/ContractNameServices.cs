    ...
    internal static class ContractNameServices
    {
        ...
        private static void WriteType(StringBuilder typeName, Type type, bool formatGenericName)
        {
            ...
            if (type.GetTypeInfo().IsGenericType)
            {
                ...
                WriteGenericType(typeName, type, type.GetTypeInfo().IsGenericTypeDefinition, genericTypeArguments, formatGenericName);
                Assumes.True(genericTypeArguments.Count == 0, "Expecting genericTypeArguments queue to be empty.");
            }
            else
            {
        ...
        private static void WriteGenericTypeName(StringBuilder typeName, Type type, bool isDefinition, Queue<Type> genericTypeArguments, bool formatGenericName)
        {
            ...
            //
            Assumes.True(type.GetTypeInfo().IsGenericType, "Expecting type to be a generic type");
        ...
        private static void WriteTypeArgumentsString(StringBuilder typeName, int argumentsCount, bool isDefinition, Queue<Type> genericTypeArguments, bool formatGenericName)
        {
            ...
            {
                Assumes.True(genericTypeArguments.Count > 0, "Expecting genericTypeArguments to contain at least one Type");
        ...
        private static int GetGenericArity(Type type)
        {
            ...
            Assumes.True(typeGenericArguments >= delclaringTypeGenericArguments);
        ...
        private static Type[] GetGenericArguments(this Type type)
        {
            ...
            return info.ContainsGenericParameters
